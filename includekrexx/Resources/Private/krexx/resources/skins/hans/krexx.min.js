...
[];for(var b=h.querySelectorAll("li span, li div.kpreview"),c=0;c<b.length;++c)-1<b[c].textContent.toLowerCase().indexOf(d)&&(a.h(b[c],"ksearch-found-highlight"),e[f][d].data.push(b[c]));e[f][d].pointer=-1}c.preventDefault();c.stopPropagation();var d=this.parentNode.querySelector(".ksearchfield").value.toLowerCase();if(2<d.length){var f=a.c(this,"instance");c=a.c(this,"direction");for(var h=document.querySelector("#"+f+" .kbg-wrapper"),l=h.querySelectorAll(".kcollapsed"),k=0;k<l.length;k++)a.s(l[k]);
...
g.v=function(c){c.preventDefault();c.stopPropagation();c=a.c(this,"instance");c=document.querySelector("#search-"+c);a.m(c,"hidden")?(a.h(c,"hidden"),c.querySelector(".ksearchfield").focus(),c.style.position="fixed"):(a.h(c,"hidden"),a.b(".ksearch-found-highlight","ksearch-found-highlight"),c.style.position="fixed",e=[])};g.toggle=function(c){c.stopPropagation();a.h(this,"kopened");a.h(this.nextElementSibling,"khidden")};g.w=function(c){var b=a.f(c,".knest"),d,f;a.b(b,"khidden");for(var e=0;e<b.length;e++)a.g([b[e].previousElementSibling],
