...
#[CoversMethod(Model\ConnectorService::class, '__construct')]
#[CoversMethod(Model\Callback::class, 'injectCallback')]
#[CoversMethod(Model\Callback::class, 'renderMe')]
#[CoversMethod(Model\Callback::class, 'addParameter')]
#[CoversMethod(Model\Json::class, 'setHelpid')]
#[CoversMethod(Model\Json::class, 'addJsonHint')]
#[CoversMethod(Model\Json::class, 'addToJson')]
#[CoversMethod(Model\Json::class, 'getJson')]
#[CoversMethod(Model\Data::class, 'setData')]
#[CoversMethod(Model\Data::class, 'getData')]
#[CoversMethod(Model\Name::class, 'setName')]
#[CoversMethod(Model\Name::class, 'getName')]
#[CoversMethod(Model\Normal::class, 'setNormal')]
#[CoversMethod(Model\Normal::class, 'getNormal')]
#[CoversMethod(Model\AdditionalType::class, 'setAdditional')]
#[CoversMethod(Model\AdditionalType::class, 'getAdditional')]
#[CoversMethod(Model\AdditionalType::class, 'setType')]
#[CoversMethod(Model\AdditionalType::class, 'getType')]
#[CoversMethod(Model\ConnectorService::class, 'getConnectorLeft')]
#[CoversMethod(Model\ConnectorService::class, 'getConnectorRight')]
#[CoversMethod(Model\DomId::class, 'setDomid')]
#[CoversMethod(Model\DomId::class, 'getDomid')]
#[CoversMethod(Model\HasExtra::class, 'hasExtra')]
#[CoversMethod(Model\HasExtra::class, 'setHasExtra')]
#[CoversMethod(Model\ConnectorService::class, 'setConnectorParameters')]
#[CoversMethod(Model\ConnectorService::class, 'getConnectorParameters')]
#[CoversMethod(Model\ConnectorService::class, 'setConnectorType')]
#[CoversMethod(Model\ConnectorService::class, 'setCustomConnectorLeft')]
#[CoversMethod(Model\ConnectorService::class, 'getConnectorLanguage')]
#[CoversMethod(Model\Callback::class, 'getParameters')]
#[CoversMethod(Model\CodeGenType::class, 'setCodeGenType')]
#[CoversMethod(Model\CodeGenType::class, 'getCodeGenType')]
#[CoversMethod(Model\Callback::class, 'isExpandable')]
#[CoversMethod(Model\ConnectorService::class, 'setReturnType')]
#[CoversMethod(Model\ConnectorService::class, 'getReturnType')]
