...
class ModelTest extends AbstractTest
{
    ...
    public function testSetEditable()
    {
        ...
        $this->assertAttributeEquals(static::VALUE, 'editable', $this->model);
    }
    ...
    public function testSetType()
    {
        ...
        $this->assertAttributeEquals(static::VALUE, 'type', $this->model);
    }
    ...
    public function testSetSection()
    {
        ...
        $this->assertAttributeEquals(static::VALUE, 'section', $this->model);
    }
    ...
    public function testSetSource()
    {
        ...
        $this->assertAttributeEquals(static::VALUE, 'source', $this->model);
    }
}
