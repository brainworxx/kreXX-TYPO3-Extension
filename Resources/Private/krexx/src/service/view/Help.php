...
class Help
{
    ...
    protected $helpArray = array(
        ...
        'useScopeAnalysis' => 'Shall kreXX analyse all reachable class properties and methods? If set to "TRUE", the default configuration for private and protected stuff is overwritten, in case that value is reachable.',
        ...
        'configErrorUseScopeAnalysis' => 'Wrong configuration for: "runtime => useScopeAnalysis"! Expected boolean. The configured setting was not applied!',
        ...
        'configErrorHandle' => 'You have entered a wrong developer handle. Please use only letters between a-z and A-Z.',
