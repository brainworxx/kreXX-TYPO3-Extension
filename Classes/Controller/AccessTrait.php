...
trait AccessTrait
{
    ...
    {
        return isset($GLOBALS[ControllerConstInterface::BE_USER]) &&
            $GLOBALS[ControllerConstInterface::BE_USER]->check(
                ControllerConstInterface::BE_MODULES,
                AbstractCollector::PLUGIN_NAME
            );
    }
}
